...
def test_valid_abi3_macos_wildcard_tag(tmp_path: Path) -> None:
    wheel = tmp_path / "oxipng_pybind-10.1.1.post1-cp310-abi3-macosx_14_0_arm64.whl"
    wheel.write_text("", encoding="utf-8")
    errors = check_wheels(
        [wheel],
        "macosx_*_arm64",
...
def test_invalid_cpython_specific_abi_tag(tmp_path: Path) -> None:
    wheel = tmp_path / "oxipng_pybind-10.1.1.post1-cp313-cp313-manylinux_2_34_x86_64.whl"
    wheel.write_text("", encoding="utf-8")
    errors = check_wheels(
        [wheel],
        "manylinux_2_34_x86_64",
...
def test_rejects_wrong_distribution_name(tmp_path: Path) -> None:
    wheel = tmp_path / "other_project-10.1.1.post1-cp310-abi3-manylinux_2_34_x86_64.whl"
    wheel.write_text("", encoding="utf-8")
...
def test_rejects_wrong_version(tmp_path: Path) -> None:
    wheel = tmp_path / "oxipng_pybind-10.1.0-cp310-abi3-manylinux_2_34_x86_64.whl"
    wheel.write_text("", encoding="utf-8")
...
def test_rejects_extra_wheel_artifacts(tmp_path: Path) -> None:
    wheel_a = tmp_path / "oxipng_pybind-10.1.1.post1-cp310-abi3-manylinux_2_34_x86_64.whl"
    wheel_b = tmp_path / "oxipng_pybind-10.1.1.post1-cp310-abi3-manylinux_2_34_aarch64.whl"
