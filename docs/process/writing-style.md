...
Write text that is easy to scan. Make it clear for readers who are tired, new
to the project, or reading in a second language. Aim for about a 7th grade
English level.
...
- Use short paragraphs. Keep closely related sentences together.
